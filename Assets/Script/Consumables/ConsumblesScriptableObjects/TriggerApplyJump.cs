...
using UnityEngine;
/*
public class TriggerApplyJump : ConsumableParentObject // This class inherits from the class PowerUpParent which also inherits from MonoBehavior. It does this because it
                                       // calls the methods of Duration() and TurnOffContumable() used in the parent 
{

    public float time = 5f; // Duration of the power up.

    public ConsumableScriptableObject speedUp; // it needs an child object of type PowerUpEffect, because PowerUpEffect is an abscract class.
